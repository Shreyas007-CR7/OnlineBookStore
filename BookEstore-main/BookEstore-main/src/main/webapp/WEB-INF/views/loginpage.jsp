...
<script src="/js/validation.js"></script>
	...
	<div class="mainForm">
		<div class="container">
			<form action="/loginhandler" method="post"  onsubmit="return validateLoginForm()" novalidate>
				<label for="email">Email</label> <br /> <input type="email"
					name="email" id="email" required /><br> <div id="email-error" style="color: red;"></div> <label for="pass">Password:</label>
				<br /> <input type="password" name="pass" id="pass" required /><br><div id="pass-error" style="color: red;"></div> 
				<br /><br> <input type="submit" value="Submit" id="button" />
